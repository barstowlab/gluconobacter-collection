...
from utilities.grid import SudokuGenomicCoord, CalculateSudokuGridOccupancyTaxonomy, \
...
# ------------------------------------------------------------------------------------------------ #
def CalculateLibraryAddressLocatabilityForPoolPresenceTableLine2(poolPresenceTableLine, \
rowPools, colPools, prPools, pcPools, controlPools, fitDict, areaDict, threshold, \
maxEntriesInSingleAddressPoolAxis, maxTotalCoords):
    ...
    return [possibleAddressesAndScores, locatability, maxSinglePoolCoordNumber, addresses_r, \
    addresses_c, addresses_pr, addresses_pc]
# ------------------------------------------------------------------------------------------------ #
...
maxEntriesInSingleAddressPoolAxis, maxTotalCoords):
    ...
    while i < len(poolPresenceTable):
        ...
        [possibleAddressesAndScores, locatability, maxSinglePoolCoordNumber, addresses_r, \
		addresses_c, addresses_pr, addresses_pc] = \
            CalculateLibraryAddressLocatabilityForPoolPresenceTableLine2(poolPresenceTableLine, \
        ...
        if locatability == 'unambiguous':
            ...
            AssignAmbiguousAddresses2(sudokuGridLookupDict, possibleAddressesAndScores, coord, \
...
def AssignAmbiguousAddresses(sudokuGridLookupDict, possibleAddressesAndScores, coord, \
	...
	# This is where we need to make an intervention
...
# ------------------------------------------------------------------------------------------------ #
def AssignAmbiguousAddresses2(sudokuGridLookupDict, possibleAddressesAndScores, coord, \
locatability, maxEntriesInSingleAddressPoolAxis):
    ...
    for prPool in prPools:
        ...
        for pcPool in pcPools:
            ...
            try:
                ...
                print('No plate at: ' + prPool + '_' + pcPool)
                pass
